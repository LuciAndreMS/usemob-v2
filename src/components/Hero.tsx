    ...
    <div className="w-full">
      <div className="section-container relative z-10 pt-28 pb-16">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="inline-block text-accent font-heading text-xs font-semibold tracking-[0.25em] uppercase mb-8 border border-accent/20 px-5 py-2 rounded-full bg-accent/5 backdrop-blur-sm">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-[4.5rem] font-heading font-bold leading-[1.04] mb-8 text-white">
            Soluções em{" "}
            <span className="text-accent">mobilidade corporativa</span> para
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-accent text-accent-foreground px-10 py-4.5 rounded-lg font-heading font-bold text-base hover:bg-accent-hover transition-all shadow-xl shadow-accent/25 hover:shadow-accent/40 hover:translate-y-[-1px]"
            >
