...
const WHATSAPP = "https://wa.me/5567999636464?text=Ol%C3%A1%21%20Quero%20solicitar%20uma%20proposta%20corporativa%20de%20transporte%20em%20Tr%C3%AAs%20Lagoas%20%28MS%29.";
      ...
      <main className="pt-20 md:pt-24 bg-[#0B0D12]">
        <section className="mx-auto max-w-6xl px-6 py-14 md:py-20">
          ...
          <p className="mt-5 max-w-3xl text-base md:text-lg text-gray-300">
            ...
            motoristas treinados, frota premium e controle de qualidade. Não é transporte “comum” — é mobilidade corporativa
            com governança e compliance.
          </p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-2 text-sm text-gray-300">Conduta, documentação e controle adequados ao B2B.</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-6">
              <h2 className="text-lg font-semibold text-white">Frota e motoristas</h2>
              <p className="mt-2 text-sm text-gray-300">Veículos executivos e profissionais treinados para operação corporativa.</p>
            </div>
          </div>
        </section>
